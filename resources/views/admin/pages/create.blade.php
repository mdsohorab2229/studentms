...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4 bg-blend-lighten">ADD STUDENT INFORMATION</h1>  
        <div class="row my-5">
            <div class="col col-8">
                ...
                <div class="form-group my-2">
                  ...
                  <input type="text" class="form-control" id="fastname" name="fastname" placeholder="Enter Your Fast Name" >           
                </div>
                <div class="form-group my-2">
